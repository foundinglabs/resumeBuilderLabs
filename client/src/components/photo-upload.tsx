        ...
        <div className="space-y-4">
              ...
              <div className="relative">
                {picture.url && !picture.effects?.hidden ? (
                  ...
                  <div className="w-12 h-12 rounded-full bg-slate-200 border-2 border-slate-300 flex items-center justify-center">
                    <span className="text-slate-600 font-medium text-lg">{getInitial()}</span>
                  </div>
                )}
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-slate-800">Profile Photo</h3>
          ...
          {picture.url && isExpanded && (
            <div className="space-y-3 pt-2 border-t border-slate-200">
              ...
              {/* Shape */}
              <div>
                <Label className="text-xs font-medium text-slate-700 mb-2 block">Shape</Label>
                <div className="flex items-center space-x-2">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => updatePictureSettings({ borderRadius: 0 })}
                    className={`text-xs ${picture.borderRadius === 0 ? 'bg-blue-50 border-blue-300' : ''}`}
                  >
                  ...
                  <Button
                    ...
                    className={`text-xs ${picture.borderRadius === 50 ? 'bg-blue-50 border-blue-300' : ''}`}
                  >
              ...
              <div className="space-y-2">
                <Label className="text-xs font-medium text-slate-700">Effects</Label>
                
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-600">Add border</span>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-600">Grayscale</span>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-600">Hide photo</span>
                  <Switch
