          ...
          {basics.location && (
            <>
              <div className="flex items-center gap-x-1.5">
                ...
                <div className="text-white">{basics.location}</div>
              </div>
              <div className="size-1 rounded-full bg-white last:hidden" />
            </>
          )}
          {basics.phone && (
            <>
              <div className="flex items-center gap-x-1.5">
                ...
                <a href={`tel:${basics.phone}`} target="_blank" rel="noreferrer" className="text-white hover:text-white visited:text-white no-underline" style={{color: 'white !important'}}>
                  {basics.phone}
                </a>
              </div>
              <div className="size-1 rounded-full bg-white last:hidden" />
          ...
          {basics.email && (
            <>
              <div className="flex items-center gap-x-1.5">
                ...
                <a href={`mailto:${basics.email}`} target="_blank" rel="noreferrer" className="text-white hover:text-white visited:text-white no-underline" style={{color: 'white !important'}}>
                  {basics.email}
                </a>
              </div>
              <div className="size-1 rounded-full bg-white last:hidden" />
          ...
          {basics.customFields && basics.customFields.map((item) => (
            <Fragment key={item.id}>
              <div className="flex items-center gap-x-1.5">
                ...
                {isUrl(item.value) ? (
                  <a href={item.value} target="_blank" rel="noreferrer noopener nofollow" className="text-white hover:text-white visited:text-white no-underline" style={{color: 'white !important'}}>
...
const Link = ({ url, icon, iconOnRight, label, className }: LinkProps) => {
  ...
  return (
    <div className="flex items-center gap-x-1.5">
      {!iconOnRight &&
        (icon ?? (
          <i className="ph ph-bold ph-link text-white" />
        ))}
      <a
        href={url.href}
        target="_blank"
        rel="noreferrer noopener nofollow"
        className={cn("text-white hover:text-white visited:text-white no-underline", className)}
...
const Custom = ({ id }: { id: string }) => {
  ...
  return (
    <Section<CustomSection>
      section={section || { visible: false, items: [] }}
      urlKey="url"
      summaryKey="summary"
